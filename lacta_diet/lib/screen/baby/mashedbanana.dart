...
class MyMashed_banana extends StatelessWidget {
   MyMashed_banana({super.key});
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Text(
                  "Preparation\nPeel a small banana and mash with a fork.Add a little milk if necessary to thin down to consistency and add some honey for a familiar taste.\n\nHow to serve:\nBananas make a great and versatile first food for babies.They can be made into a baby food puree mashed into a chunky puree used as a finger food for baby or prepared for baby led weaning.\n\nChoking hazard for babies:\nIf the banana is not riped and ready to eat flesh will bw harder and pose a higher choking risk for your baby.\n\nBenefits\nBananas are packed with carbohydrates to energies the body and essential nutrients that babies need to thrive like\nFolate\nvitamin B6\nvitamin C\nPotassium together these skin health for iron absorption and blood pressure.\n\nNutritional Values:\n\nProtein   1.1g\nCarbs    22.8g\nHoney   34g\nFiber    6g\nFat    0.3g",
                  style: TextStyle(
                    fontSize: 18,
                    color: font,
                    fontFamily: 'ro',
